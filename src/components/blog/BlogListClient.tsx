        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {BLOGS.map((blog) => (
            <Link
              key={blog.id}
              href={`/blog/${blog.slug}`}
              className="bg-white rounded-2xl border border-[#E8E8EE] overflow-hidden shadow-2xs hover:border-[#FC5C03]/50 hover:shadow-md transition-all flex flex-col justify-between group"
            >
              <div>
                <div className="relative aspect-video w-full bg-gray-50 overflow-hidden">
                  ...
                  />
                  <span className="absolute top-2.5 left-2.5 px-2.5 py-0.5 bg-[#1A1D26]/90 backdrop-blur-xs text-white text-[10px] font-bold rounded-md">
                    {blog.category}
                  </span>
                </div>
                ...
                <div className="p-5 space-y-2.5">
                  ...
                  <h3 className="text-base font-bold text-[#1A1D26] group-hover:text-[#FC5C03] transition-colors leading-snug">
                    {blog.title}
                  </h3>
              ...
              <div className="p-5 pt-0">
                <span className="inline-flex items-center gap-1 text-xs font-bold text-[#FC5C03] group-hover:translate-x-1 transition-transform">
